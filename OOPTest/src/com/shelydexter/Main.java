...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Each fo these items gets charged an additional price so you may need some way to track how many items got added
        ...
        // a) Healthy burger 9on a brown rye bread roll), plus two addition items that can be added.
        // The healthy burger can have 6 items (Additions) in total.
        // hint: you probably want to process the two additional items in this new class (subclass of Hamburger),
        // not the base class (Hamburger), since the two additions are only appropriate for this new class
        // (in other words new burger type).
        // b) Deluxe hamburger - comes with chips and drinks as additions, but no extra additions are allowed.
        // hint: You have to find a way to automatically add these new additions at the time of the deluxe burger
        ...
        System.out.println(addition.getName() + " " + addition.getQuantity() + " " + addition.getPrice() + " " + addition.getTotal());
        System.out.println(lettuce.getName() + " " + lettuce.getQuantity() + " " + lettuce.getPrice() + " " + lettuce.getTotal());
        System.out.println(tomato.getName() + " " + tomato.getQuantity() + " " + tomato.getPrice() + " " + tomato.getTotal());
        System.out.println(pickle.getName() + " " + pickle.getQuantity() + " " + pickle.getPrice() + " " + pickle.getTotal());
    }
}
